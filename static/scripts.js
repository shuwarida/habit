    ...
    methods: {
        ...
        setHabitVal: function(arr_x,arr_y,val) {
            ...
            if (typeof this.habits_val === 'object' && this.habits_val !== null) {
                ...
                if (typeof this.habits_val[arr_x] === 'object' && this.habits_val[arr_x] !== null) {
                    if (typeof this.habits_val[arr_x][arr_y] === 'string' && this.habits_val[arr_x][arr_y] !== null) {
                        this.habits_val[arr_x][arr_y] = val
                    } else {
                        var newVal = {}
                        newVal[arr_y] = val
                        this.habits_val[arr_x] = Object.assign( {}, this.habits_val[arr_x], newVal);
                    }
